...
(function () {
  ...
  function mapBasic(b) {
    ...
    return {
      ...
      nationality: s(src.nationality || src.country),
      hukou: s(src.hukou || src.hukou_location),
      current_city: s(src.current_city || src.city || src.location),
      political_status: s(src.political_status),
      marital_status: s(src.marital_status),
      native_place: s(src.native_place),
      current_company: s(src.current_company || src.company),
      current_title: s(src.current_title || src.position || src.title),
      years_experience: s(src.years_experience),
      height: s(src.height),
      weight: s(src.weight),
      wechat: s(src.wechat),
      qq: s(src.qq),
  ...
  function mapEducation(arr) {
    ...
    return arr
      ...
      .map((e) => ({
        ...
        major: s(e.major),
        degree: s(e.degree),
        study_mode: s(e.study_mode || e.education_type),
        advisor: s(e.advisor || e.tutor),
        ranking: s(e.ranking),
        city: s(e.city),
